      ...
      containers:
        - image: docker.io/vhiveease/relay:latest
          ...
          args:
            ...
            - --function-name=fibonacci-nodejs
            - --value=10
            - --generator=random
            - --lowerBound={x}
            - --upperBound={y}
            - --profile-function=true
        - image: docker.io/vhiveease/fibonacci-nodejs-mod:latest
          args:
            - --addr=0.0.0.0
            - --port=50051
"""
...
# List of x values
x_values = [10, 1000, 4500, 10000, 20000, 45000, 70000, 100000, 200000, 450000, 700000, 1000000, 2000000, 3000000]
