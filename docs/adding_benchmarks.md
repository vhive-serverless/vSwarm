...
[serving](/benchmarks/chained-function-serving/yamls/knative/inline/service-producer.yaml) and
...
[example manifests](/benchmarks/chained-function-serving/yamls/knative/inline/service-producer.yaml) for
support.
