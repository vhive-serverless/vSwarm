...
replace (
	github.com/bcongdon/corral => github.com/ease-lab/corral v0.0.0-20221113134201-ecd62d45d071
...
require (
	...
	github.com/vhive-serverless/vSwarm/utils/tracing/go v0.0.0-20221113123755-a981665b90f4
